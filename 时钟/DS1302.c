...
{
	output[0]=BCD2Hex(Read(0x8D));
	Delay1ms();
	output[1]=BCD2Hex(Read(0x8B));
	Delay1ms();
	output[2]=BCD2Hex(Read(0x89));
	Delay1ms();
	output[3]=BCD2Hex(Read(0x87));
	Delay1ms();
	output[4]=BCD2Hex(Read(0x85));
	Delay1ms();
	output[5]=BCD2Hex(Read(0x83));
	Delay1ms();
	output[6]=BCD2Hex(Read(0x81));
	Delay1ms();
}